...
const Back4 = () => {
  ...
  const volumeHandler1 = () => {
    if (volumi1 === 0) {
      setVolumi1(1);
      document.getElementById("videoo2").muted = false;
    }
    if (volumi1 === 1) {
      setVolumi1(0);
      document.getElementById("videoo2").muted = true;
    }
  };
    ...
    <div className="App">
      <div>
        {mediahandler && (
          ...
          >
            <source
              src="https://lv-vod.fl.freecaster.net/vod/louisvuitton/bEeWnvFTh8_MD.mp4"
              type="video/mp4"
            />
          </video>
        )}
        {!mediahandler && (
          ...
          >
            <source
              src="https://lv-vod.fl.freecaster.net/vod/louisvuitton/JQd4UPcUXV_HD.mp4"
              type="video/mp4"
            />
          </video>
        )}
