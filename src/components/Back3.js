...
const Back3 = () => {
  ...
  const volumeHandler1 = () => {
    if (volumi1 === 0) {
      setVolumi1(1);
      document.getElementById("videoo1").muted = false;
    }
    if (volumi1 === 1) {
      setVolumi1(0);
      document.getElementById("videoo1").muted = true;
    }
  };
    ...
    <div className="App">
      <div>
        {mediahandler && (
          ...
          >
            <source
              src="https://lv-vod.fl.freecaster.net/vod/louisvuitton/NKqk4kF5ue_MD.mp4"
              type="video/mp4"
            />
          </video>
        )}
        {!mediahandler && (
          <video
            ...
            ref={vidRef1}
            id="videoo1"
            className="video1 okey"
          >
            <source
              src="https://lv-vod.fl.freecaster.net/vod/louisvuitton/nsUXL1pT7q_HD.mp4"
              type="video/mp4"
            />
          </video>
        )}
